...
<html lang="uk">
  ...
  <body>
    <?php
      ...
      $index_cont = mysql_fetch_array(mysql_query("SELECT * FROM contacts WHERE id='1' ", $db));
      $index_about = mysql_fetch_array(mysql_query("SELECT * FROM about WHERE id='1' ", $db));
    ?>
        <div class="container-fluid">
           <div class="row">
            <div class="pre_header">
                ...
                <div class="btn-group">
                    <a href="#"><button type="button" class="btn btn-default">ua</button></a>
                    <a href="index-pl.php"><button type="button" class="btn btn-default">pl</button></a>
                    <a href="index-eng.php"><button type="button" class="btn btn-default">eng</button></a>
                </div>
            </div>
            <header>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                        ...
                        <a class="navbar-brand" href="#"><p>LegalExpert</p><p class="text-center">послуги для бізнесу</p></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="nav_service"><a href="#">Послуги</a></li>
                        <li class="nav_discusion"><a href="#">Ситуації для бізнесу</a></li>
                        <li class="nav_about"><a href="#">Про нас</a></li>
                        <li class="nav_contact"><a href="#">Контакти</a></li>        
                      </ul>
                    ...
                    <div class="col-md-12">
                         <div class="title">
                          <h4><p class="text-center">НАШІ ПОСЛУГИ</p></h4>
                         </div> 
                    </div>
                    </div>
                    <div class="row row-eq-height">
                      <div class="col-sm-5">
                           <div class="service" data-lang="uk">
                              <ul id="myTab">                              
                              </ul>
                           </div>
                     </div>
                     <div class="col-sm-7 hidden-xs">
                          <div class="text tab-content" id="myTabContent" data-lang="uk">
                          </div>
                     </div>
                    </div>
                    ...
                    <div class="news_wrapper">
                        <div class="col-md-12">
                           <div class="title2" id="news_offset">
                               <h4><p class="text-center">СИТУАЦІЇ ДЛЯ БІЗНЕСУ</p></h4>
                           </div>
                        </div>
                       <div class="col-sm-8">
                           <div class="actual" data-lang = 'uk'>
                              <h5><b><p class="text-center">Найбільш актуальні</p></b></h5>                                                   
                           </div>                           
                       </div>
                       <div class="col-sm-4">
                           <div class="archive" data-lang = 'uk'>
                               <h5><b><p class="text-center">Архів</p></b></h5>
                               <ul>                                   
                               </ul>
                               <!-- Modal -->
                  ...
                  <div class="row">
                        <div class="col-lg-12">
                           <div class="title2" id="about_offset">
                               <h4><p class="text-center">ПРО НАС</p></h4>
                           </div>
                        </div>
                       <div class="about">
                           <p>
                    ...
                    <div class="col-lg-12">
                           <div class="title2" id="contact_offset">
                               <h4><p class="text-center">КОНТАКТИ</p></h4>
                           </div>
                    </div>
                    <div class="container-fluid">
                        <div class="contact">
                        ...
                        <div class="col-sm-7">
                            <form class="contact-form" data-lang='uk'>
                              ...
                              <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Введіть адресу електронної пошти">
                              </div>
                              <div class="form-group">
                                <textarea class="form-control" id="message" name="message" placeholder="Введіть повідомлення сюди" rows="3"></textarea>
                              </div>
                              <button type="submit" class="btn btn-primary" name="submit">Відправити</button>
                            </form>
                            <div class="alert alert-success confirmation hidden"><span class="glyphicon glyphicon-star"></span>Дякуємо за Ваше повідомлення! Ми дамо на нього відповідь якомога швидше. </div>
                        </div>  
                    </div>
                    </div>
                   ...
                   <div class="row">
                        <footer>
                            ...
                            <div class="rights hidden-xs">
                                <p>
                                    Всі права захищено ©2015
                                </p>
                            </div>
                            <div class="links hidden-xs">
                                 <span class="glyphicon glyphicon-earphone" data-toggle="tooltip" data-placement="bottom" title="(067)167-79-15, (093)672-98-66"></span><p class="hidden-xs"><?php echo $index_cont['phone'];?></p>
                                 <br>
